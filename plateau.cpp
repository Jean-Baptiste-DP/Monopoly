...
plateau::plateau(jeu *monJeu) {
    ...
    lesTerrains[21]=Terrain("Rue de la Paix",400,50,200,600,1400,1700,2000,200);
    lesTaxes[1]=Taxes("Taxe de Luxe",100);
    lesTerrains[20]=Terrain("Avenue des Champs-Élysées",350,35,175,500,1100,1300,1500,200);
    lesChances[2]=Chance("Chance");
    lesGares[3]=Gare("Gare Saint Lazare",200);
    lesTerrains[19]=Terrain("Boulevard des Capucins", 320,28,150,450,1000,1200,1400,200);
    lesCommunautes[2]=Communaute("Caisse de Communauté");
    lesTerrains[18]=Terrain("Avenue Foch",300,26,130,390,900,1100,1275,200);
    lesTerrains[17]=Terrain("Avenue de Breteuil",300,26,130,390,900,1100,1275,200);
    lesPrisons[1]=Prison("Aller en prison");
    lesTerrains[16]=Terrain("Rue de la Fayette",280,24,120,360,850,1025,1200,150);
    lesCompagnies[1]=Compagnie("Compagnie de distribution des eaux",150);
    lesTerrains[15]=Terrain("Place de la Bourse",260,22,110,330,800,975,1150,150);
    lesTerrains[14]=Terrain("Faubourg Saint-Honoré",260,22,110,330,800,975,1150,150);
    lesGares[2]=Gare("Gare du Nord",200);
    lesTerrains[13]=Terrain("Avenue Henri-Martin",240,20,100,300,750,925,1100,150);
    lesTerrains[12]=Terrain("Boulevard Malesherbes",220,18,90,250,700,875,1050,150);
    lesChances[1]=Chance("Chance");
    lesTerrains[11]=Terrain("Avenue Matignon",220,18,90,250,700,875,1050,150);
    leParc=Parc();
    lesTerrains[10]=Terrain("Place Pigalle",200,16,80,220,600,800,1000,100);
    lesTerrains[9]=Terrain("Boulevard Saint Michel",180,14,70,200,550,750,950,100);
    lesCommunautes[1]=Communaute("Caisse de Communauté");
    lesTerrains[8]=Terrain("Avenue Mozard",180,14,70,200,550,750,950,100);
    lesGares[1]=Gare("Gare de Lyon",200);
    lesTerrains[7]=Terrain("Rue de Paradis",160,12,60,180,500,700,900,100);
    lesTerrains[6]=Terrain("Avenue de Neuilly",140,10,50,150,450,625,750,100);
    lesCompagnies[0]=Compagnie("Compagnie de distribution d'électricité",150);
    lesTerrains[5]=Terrain("Boulevard de la Villette",140,10,50,150,450,625,750,100);
    lesPrisons[0]=Prison("Prison");
    lesTerrains[4]=Terrain("Avenue de la République",120,8,40,100,300,450,600,50);
    lesTerrains[3]=Terrain("Rue de Courcelles",100,6,30,90,270,400,550,50);
    lesChances[0]=Chance("Chance");
    lesTerrains[2]=Terrain("Rue de Vaugirard",100,6,30,90,270,400,550,50);
    lesGares[0]=Gare("Gare Montparnasse",200);
    lesTaxes[0]=Taxes("Impôts sur le revenu",200);
    lesTerrains[1]=Terrain("Rue Lecourbe",60,4,20,60,180,320,450,50);
    lesCommunautes[0]=Communaute("Caisse de Communauté");
    lesTerrains[0]=Terrain("Boulevard de Belleville",60,2,10,30,90,160,250,50);
